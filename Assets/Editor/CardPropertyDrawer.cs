...
[CustomEditor(typeof(TestPlugin))]
...
public class LookAtPointEditor : Editor 
{
    ...
    void OnEnable()
    {
        //playerCard = serializedObject.FindProperty("playerCard");
    ...
    {
        base.OnInspectorGUI();
        TestPlugin tp = (TestPlugin) target;
        tp.playerCard.SetName();
        foreach (var c in tp.playerHand)
        {
            c.SetName();
        }
